...
CREATE TABLE files (id INTEGER PRIMARY KEY AUTOINCREMENT, report_id INTEGER, name VARCHAR, datetime DATETIME, direction INTEGER, linked_id INTEGER, type_id INTEGER, uuid VARCHAR (36));
